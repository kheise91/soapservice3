...
public class NdfdXMLLocator extends org.apache.axis.client.Service implements gov.weather.weatherservice.NdfdXML {
 ...
 */
    ...
    public gov.weather.weatherservice.NdfdXMLPortType getndfdXMLPort() throws javax.xml.rpc.ServiceException {
    ...
    public gov.weather.weatherservice.NdfdXMLPortType getndfdXMLPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            gov.weather.weatherservice.NdfdXMLBindingStub _stub = new gov.weather.weatherservice.NdfdXMLBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (gov.weather.weatherservice.NdfdXMLPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                gov.weather.weatherservice.NdfdXMLBindingStub _stub = new gov.weather.weatherservice.NdfdXMLBindingStub(new java.net.URL(ndfdXMLPort_address), this);
                _stub.setPortName(getndfdXMLPortWSDDServiceName());
                return _stub;
            }
        }
